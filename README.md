...
└── tests/               guard (59), memory (39), state (12), recipes (8)
```

## Checks that actually run

Four things in here are enforced by code rather than good intentions, because prose rules drift and nobody notices. **117 assertions, run on every push:**
